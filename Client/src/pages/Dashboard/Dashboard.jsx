  ...
  return (
    <>
      {loading ? (
        ...
        <>
          <div className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] flex flex-col gap-10 bg-[#0a1a2e] text-white">
            <h1
              className={`text-[#1e90ff] text-2xl font-bold mb-2 min-[480px]:text-4xl md:text-6xl xl:text-7xl 2xl:text-8xl`}
            >
              Dashboard
            </h1>
            <div className="flex flex-col gap-10">
              <div>
                <h3 className="text-[#87cefa] text-xl font-semibold mb-2 min-[480px]:text-xl md:text-2xl lg:text-3xl">
