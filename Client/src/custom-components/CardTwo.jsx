...
const CardTwo = ({ imgSrc, title, startingBid, startTime, endTime, id }) => {
  ...
  return (
    <>
      <div className="ring-1 basis-full bg-white rounded-md group sm:basis-56 lg:basis-60 2xl:basis-96">
        <img
          src={imgSrc}
          alt={title}
          className="w-full aspect-[5/4] m-auto md:p-12"
        />
        <div className="px-2 pt-4 pb-2">
          <h5 className="font-semibold text-[18px] group-hover:text-[#8EC5FC] mb-2">
            {title}
          </h5>
          {startingBid && (
            <p className="text-stone-600 font-light">
              Starting Bid:{" "}
              <span className="text-[#8EC5FC] font-bold ml-1">
                {startingBid}
              </span>
            </p>
          )}
          <p className="text-stone-600 font-light">
            ...
            {Object.keys(timeLeft).length > 1 ? (
              ...
              <span className="text-[#f13936] font-bold ml-1">Time is up!</span>
            )}
          </p>
    ...
    >
      <div className="bg-white h-fit transition-all duration-300 w-full">
        <div className="w-full px-5 py-8 sm:max-w-[640px] sm:m-auto">
          <h3 className="text-[#8EC5FC]  text-3xl font-semibold text-center mb-1">
            Republish Auction
          </h3>
